...
*Companion to [sliide-kmp-user-management](https://github.com/kanav22/sliide-kmp-user-management)*
...
The code is in [sliide-kmp-user-management](https://github.com/kanav22/sliide-kmp-user-management). The patterns transfer directly to fintech Android monorepos—replace the user API with your domain, keep the boundaries.
